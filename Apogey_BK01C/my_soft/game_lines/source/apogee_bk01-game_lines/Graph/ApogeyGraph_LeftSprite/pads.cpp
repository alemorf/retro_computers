      ...
      for(int x=0; x<bmp.GetWidth(); x+=3) {
        ...
        for(int sy=0; sy<2; sy++)
          for(int sx=0; sx<3; sx++) {
            ...
            if(c1==0xFFFF00) c1=0x81, bl=0; else
            if(c1==0x00FFFF) c1=0x84, bl=0; else
            if(c1==0x0000FF) c1=0x8C, bl=0; else
            if(c1==0x00FF00) c1=0x85, bl=0; else
            if(c1==0xFF0000) c1=0x89, bl=0; else
