...
static const uint8_t PORT_VG93_COMMAND = 0xC2;
static const uint8_t PORT_FLOPPY = 0xC3;
static const uint8_t PORT_FLOPPY_WAIT = 0xC3;
static const uint8_t PORT_FLOPPY__SEL_A = 1 << 0;
static const uint8_t PORT_FLOPPY__SEL_B = 1 << 1;
static const uint8_t PORT_FLOPPY__SIDE = 1 << 2;
static const uint8_t PORT_FLOPPY__NEG_HALT = 1 << 5;
static const uint8_t PORT_FLOPPY__NEG_DDEN = 1 << 6;
static const uint8_t PORT_FLOPPY__NEG_TST = 1 << 7;
static const uint8_t PORT_VG93_TRACK = 0xC2 | (1 << 2);
static const uint8_t PORT_VG93_SECTOR = 0xC2 | (2 << 2);
static const uint8_t PORT_VG93_DATA = 0xC2 | (3 << 2);
