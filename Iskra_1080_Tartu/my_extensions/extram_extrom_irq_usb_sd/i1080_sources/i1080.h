...
static const int PORT_SD_SIZE = 9;
static const int PORT_SD_RESULT = 9;
static const int PORT_SD_DATA = 8;
...
static const int SD_COMMAND_READ = 1;
static const int SD_COMMAND_READ_SIZE = 5;
static const int SD_COMMAND_WRITE = 2;
static const int SD_COMMAND_WRITE_SIZE = 5 + 128;

/* Ответ SD контроллера */
static const int SD_RESULT_BUSY = 0xFF;
static const int SD_RESULT_OK = 0;
