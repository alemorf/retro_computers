...
/* Unused 0xF762, 0xF763 */
extern uint8_t readedKeyboardRow __address(0xF764);
...
/* C<адрес>,<адрес>,<байт> - Сравнение содержимого двух областей памяти */
