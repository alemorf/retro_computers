...
#define ESC_HOME_CURSOR  "\x1B9  "
#define ESC_CLEAR_SCREEN "\x1B64\x1B82\x1B8D"
...
void drawBoard() {
    ...
    printf("\x1B432048.c %23d pts\x1B42",score);
    for (y=0;y<SIZE;y++) {
        printf("\n\n\n\n");
        for (x=0;x<SIZE;x++) {
            if (board[x][y]!=0) {
                ...
                t = 7-strlen(s);
                printf("|\x1B41%*s%s%*s\x1B42",t-t/2,"",s,t/2,"");
            } else {
                printf("|       ");
            }
        }
