...
void main() {
 ...
 //         startGame();
  ...
  while(1) {
    ...
    switch(c) {
      case K_PATH:       showPath  = !showPath;  drawOnOff(0, showPath);  break;
      case K_SOUND:      playSound = !playSound; drawOnOff(1, playSound); break;
      case K_HELP:       showHelp  = !showHelp;  drawOnOff(2, showHelp);  redrawNewBalls2(); break;
      case K_RECORD:
        prepareRecordScreen();
        drawRecordScreen(-1);
        getch_();
...
/*      case K_UP:
      ...
      case K_D:
        ...
        drawScore1();
        break;*/
      case K_UP:    clearCursor(); if(cursorY==0) cursorY=8; else cursorY--; drawCursor(); break;
      case K_DOWN:  clearCursor(); if(cursorY==8) cursorY=0; else cursorY++; drawCursor(); break;
      case K_LEFT:  clearCursor(); if(cursorX==0) cursorX=8; else cursorX--; drawCursor(); break;
      case K_RIGHT: clearCursor(); if(cursorX==8) cursorX=0; else cursorX++; drawCursor(); break;
      case K_SPACE: 
