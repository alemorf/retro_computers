    ...
    for(int y=0; y<bmp.GetHeight(); y++) {
      ...
      for(int sx=0; sx<8; sx++) {
        ...
        switch(clr.GetValue() & 0xFFFFFF) {
          case 0xFFFFFF: c1 = 0x00; break;
          case 0xFFFF00: c1 = 0x10; break;
          case 0xFF00FF: c1 = 0x40; break;
          case 0xFF0000: c1 = 0x50; break;
          case 0x00FFFF: c1 = 0x80; break;
          case 0x00FF00: c1 = 0x90; break;
          case 0x0000FF: c1 = 0xC0; break;
          default: c1 = 0xF0;
        }
        d <<= 1;
        if(c1 != 0xF0) { if(cc1 == 0xF0 || cc1==0) clr1=clr, cc1 = c1; d |= 1; }
      }
      if(bmp2)
        for(int sx=0; sx<8; sx++)
          bmp2->SetPixel(x+sx, y, (d & (0x80 >> sx)) ? clr1 : Gdiplus::Color::Black);
      if(cc1 != 0xF0) pcc = cc1;
